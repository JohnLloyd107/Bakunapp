...
public class A4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rgstbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TextView a4 = (TextView) findViewById(R.id.textView5);
                String categ = a4.getText().toString();
                ...
                Intent nextact = new Intent(A4.this, Register.class);
        ...
        backtbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent nextact = new Intent(A4.this, Category.class);
                nextact.putExtra("lastname",lastnames);
                nextact.putExtra("firstname",firstnames);
                nextact.putExtra("middlename",middlenames);
                nextact.putExtra("suffix",suffixs);
    ...
    public void onBackPressed(){
        finish();
        startActivity(new Intent(A4.this,Category.class));
