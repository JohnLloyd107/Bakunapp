...
public class Roap extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_roap);
        ...
        rgstbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TextView roap = (TextView) findViewById(R.id.roap);
                String categ = roap.getText().toString();
                ...
                Intent nextact = new Intent(Roap.this, Register.class);
        ...
        backtbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent nextact = new Intent(Roap.this, Category.class);
                nextact.putExtra("lastname",lastnames);
                nextact.putExtra("firstname",firstnames);
                nextact.putExtra("middlename",middlenames);
                nextact.putExtra("suffix",suffixs);
    ...
    public void onBackPressed(){
        finish();
        startActivity(new Intent(Roap.this,Category.class));
